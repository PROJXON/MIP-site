    ...
    },
    {
      ...
      content: (
        <div className="space-y-8">
          <div>
            <h4 className="text-gray-300 pb-4 pt-4">
              Claremont Graduate University
            </h4>
            <p className="text-gray-300">
              Claremont Graduate University's Master's students, particularly
              from Information Systems & Technology, have excelled in roles like
              AI Analyst and Data Scientist. They bring advanced analytical
              skills to the program and leave with a portfolio of tangible,
          ...
          <div>
            ...
            <p className="text-gray-300">
              Students from the Illinois Institute of Technology, often from
              graduate programs like the MS in Project Management, thrive in our
              fast-paced environment. They take on key responsibilities as
              Project Managers and Business Analysts, gaining invaluable
              experience translating complex technical goals into successful
              project deliveries.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300">
              ...
              consistently make a major impact as interns. By taking on roles
